                ...
                <div
                    ...
                    <div class="bx_book_sort_area d-flex pt-5 pt-md-0">
                        <div class="bx_book_sort_option">
                            <form action="" method="get" id="bx_book_sort_form_boimela">
    ...
    <div class="container p-md-0">
        <div class="row">
            <div class="col-5 col-md-9">
                {{-- {{ $boimela->id }} --}}
                @foreach ($boimela as $category)
                @foreach ($category->first()->subcategory as $subcat)
                <div class="pb-5">
                    <div class="bx_boimela_section bx_section_inner_p_30 bx_section_box">
                        <div class="bx_section_headding bx_font_18_m d-flex justify-content-between">
                            <h3>{{ $subcat->title }}</h3>
                            <a class="bx_boimela_view_btn bx_font_16_m"
                                href="{{ url('/category/?category='.$category->first()->id.'&sub='. $subcat->id) }}">View
                                All</a>
                        </div>
                        <div class="row">
                            @foreach ($subcat->books->take(4) as $book)
                            <div class="col-md-3 pt-0">
                                <div class="bx_author_book_item item">
                                    <div class="bx_author_book_wrapper">
                                        <a class="bx_author_book_link" href="{{ url('book/'.$book->id .'/'.strtolower(str_replace(" ", "-", $book->title))) }}" target="_blank">
...
<script>
    ...
    $("#bx_book_sort").on("change",function(){
        ...
        let formData = $('#bx_book_sort_form_boimela').serialize();
            window.location.href = '/boimela?' + formData;
