                ...
                <div
                    ...
                    <div class="bx_book_sort_area d-flex pt-5 pt-md-0">
                        <div class="bx_book_sort_option">
                            <form action="" method="get" id="bx_book_sort_form_grid">
                            ...
                            <div class="bx_book_item_img_content">
                                ...
                                <div class="bx_book_item_overlay">
                                    <ul>
                                        ...
                                        <li
                                            class="{{ (Auth::check() && $book->wishlist_to_users()->where('user_id', Auth::user()->id)->exists()) ? 'active' : '' }}">
                                            <span data-id="{{ $book->id }}"
                                                class="bx_book_wishlist bx_book_wishlist_btn"><i
                                                    class="fas fa-heart"></i></span></li>
                                    </ul>
                                </div>
                                @if (Carbon\Carbon::parse($book->created_at)->diffInDays(Carbon\Carbon::now()) < 15)
                                <span class="bx_badge d-flex justify-content-end flex-column">
                                        new
                        ...
                        <div class="bx_book_filter_range">
                            ...
                            <div class="bx_book_filter_price_btn d-flex justify-content-between align-items-center">
                                ...
                                <div class="bx_book_filter_btn">
                                    <button type="button" name="" id="bx_book_filter_price" class="btn bx_btn">Filter</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="bx_book_show_style bx_section_p_30 d-md-none pt-0">
    <div class="container p-md-0">
        <div class="row">
            <div class="col-12">
                <div class="row">
...
<script>
    ...
    $("#bx_book_sort").on("change",function(){
        ...
        let formData = $('#bx_book_sort_form_grid').serialize();
        let urlParams = new URLSearchParams(window.location.search);
        let category = urlParams.get('category');
        if (category != null) {
            let finalForm = "/book/grid?category=" + category + "&" + formData;
            window.location.href = finalForm;
        } else {
            let finalForm = "/book/grid?" + formData;
            window.location.href = finalForm;
        }
      });
