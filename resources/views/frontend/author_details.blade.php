        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-4 col-lg-4 mt-3 mt-md-0 pr-md-0">
                <div class="breadcrumb_content">
                    ...
                    <nav class="breadcrumb">
                        ...
                        <a class="breadcrumb-item  bx_font_16_r" href="{{ route('books.authors') }}">Authors</a>
                        <span class="breadcrumb-item bx_font_16_r active">{{ $author->name }}</span>
                    </nav>
                </div>
            ...
            <div class="col-12 col-md-8 col-lg-8 pl-md-0">
                <div class="bx_author_details_info">
                    <div class="row">
                        <div class="col-2">
                            <div class="bx_author_details_imag">
                                <img class="img-fluid rounded-circle" alt="Humayun Ahmed books"
                                    src="{{ asset('images/author/' . $author->photo) }}">
                            </div>
                        </div>
                        <div class="col-10">
                            <h4 class="bx_author_details_title bx_font_18_m">{{ $author->name }}</h4>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="bx_book_text">
                                            ...
                                            <span>${{ $recent_book->discount != null ? ($recent_book->price - ($recent_book->price * $recent_book->discount) / 100) : $recent_book->price  }}</span>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
