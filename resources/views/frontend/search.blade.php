                ...
                <div
                    ...
                    <div class="bx_book_sort_area d-flex pt-5 pt-md-0">
                        <div class="bx_book_sort_option">
                            <form action="" method="get" id="bx_book_sort_form_search">
                                <div class="form-group position-relative">
                                    <select class="form-control" name="sort" id="bx_book_sort">
                                        <option value="">Default Sorting</option>
                                        <option value="ID_DESC" {{ Request::get('sort') ==  'ID_DESC' ? 'selected' : ''}}>New Released</option>
                                        ...
                                        <option value="DISCOUNT_ASC" {{ Request::get('sort') ==  'DISCOUNT_ASC' ? 'selected' : ''}}>Discount - Low to High</option>
                                        <option value="DISCOUNT_DESC" {{ Request::get('sort') ==  'DISCOUNT_DESC' ? 'selected' : ''}}>Discount - High to Low</option>
                                    </select>
...
<script>
    ...
    $("#bx_book_sort").on("change",function(){
        ...
        let formData = $('#bx_book_sort_form_search').serialize();
        let urlParams = new URLSearchParams(window.location.search);
        let myParam = urlParams.get('term');
        let finalForm = "search?term=" + myParam + "&"+ formData;
