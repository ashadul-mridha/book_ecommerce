            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <strong class="card-title">Update Publisher</strong>
                        ...
                        <form action="{{ route('admin.publishers.update', $publisher->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class=" form-group">
                                ...
                                <textarea name="description" id="description" rows="4" placeholder="Content..."
                                    class="form-control">
                                            {{ old('description', isset($publisher) ? $publisher->description : '') }}</textarea>
                            ...
                            <div class=" form-group ">
                                ...
                                <input type="file" id="photo" name="photo"
                                    ...
                                    <img src="{{asset('images/publisher/'.$publisher->photo)}}" alt="Autor Photo"
                                            width="50px">
                                @if ($errors->has('photo'))
