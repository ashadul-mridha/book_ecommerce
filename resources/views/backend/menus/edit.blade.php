                        ...
                        <form action="{{ route('admin.menus.update', $menu->id) }}" method="POST"
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text" id="item_one"
                                    ...
                                    name="item_one" value="{{ old('item_one', isset($menu) ? $menu->item_one : '') }}">
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text" id="item_two"
                                    ...
                                    name="item_two" value="{{ old('item_two', isset($menu) ? $menu->item_two : '') }}">
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text" id="item_six"
                                    ...
                                    name="item_six" value="{{ old('item_six', isset($menu) ? $menu->item_six : '') }}">
