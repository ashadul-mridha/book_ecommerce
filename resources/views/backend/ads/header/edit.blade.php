            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a class="btn btn-sm btn-success" href="{{ route('admin.adsheader.index') }}">Back</a>
                    </div>
                    <div class="card-body card-block">
                        <form action="{{ route('admin.adsheader.update', $ads->id) }}" method="POST"
                            ...
                            <div class="row form-group ">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <img class="pt-3" width="200px"
                                        src="{{asset('images/ads/header/' . $ads->image)}}" alt="logo">
                                    @if ($errors->has('image'))
