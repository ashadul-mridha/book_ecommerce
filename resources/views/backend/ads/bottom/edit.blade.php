            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <strong class="card-title">Update Ads</strong>
                        <a class="btn btn-sm btn-success" href="{{ route('admin.adsbottom.index') }}">Back</a>
                    </div>
                    <div class="card-body card-block">
                        <form action="{{ route('admin.adsbottom.update', $ads->id) }}" method="POST"
                            ...
                            <div class="row form-group ">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <img class="pt-3" width="200px"
                                        src="{{asset('images/ads/bottom/' . $ads->image)}}" alt="logo">
                                    @if ($errors->has('image'))
                            ...
                            <div class="row form-group ">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="link" name="link"
                                        ...
                                        value="{{ old('link', isset($ads) ? $ads->link : '') }}">
                                    @if ($errors->has('link'))
                            ...
                            <div class="row form-group ">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <img class="pt-3" width="200px"
                                        src="{{asset('image_twos/ads/bottom/' . $ads->image_two)}}" alt="logo">
                            ...
                            <div class="row form-group ">
                                <div class="col col-md-3"><label for="link_two" class=" form-control-label">Link</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="link_two" name="link_two"
                                        class="form-control-file {{ $errors->has('link_two') ? 'is-invalid' : '' }}"
                                        value="{{ old('link_two', isset($ads) ? $ads->link_two : '') }}">
