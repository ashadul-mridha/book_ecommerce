            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <strong class="card-title">All Login Page</strong>

                        <a class="btn btn-sm btn-success" href="{{ route('admin.login-pages.create') }}">Add
                            Photo</a>
                    ...
                    <div class="card-body">
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $id }}</td>
                                    <td><img src="{{asset('images/login'). '/'.$banner->image}}" alt="Logo"
                                            width="250px">
                                    </td>
                                    <td>
                                        @if ($banner->status == 1)
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-info"
                                            href="{{ route('admin.login-pages.edit', $banner->id) }}">
                                            Edit
                                        </a>

                                        <form action="{{ route('admin.login-pages.destroy', $banner->id) }}" method="POST"
                                            class="d-inline">
