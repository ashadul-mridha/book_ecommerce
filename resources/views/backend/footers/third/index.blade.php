            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <strong class="card-title">Foote Third Cloumn Data</strong>
                        @can('manage-footers')
                        @if (count($footers) <= 0) <a class="btn btn-sm btn-success"
                            href="{{ route('admin.third.create') }}">Add
                            Third Cloumn</a>
                            @endif
                            @endcan
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-info"
                                            href="{{ route('admin.third.edit', $footer->id) }}">
                                            Edit
                                        </a>
                                        @if (count($footers) > 1)
                                        <form action="{{ route('admin.third.destroy', $footer->id) }}" method="POST"
                                            class="d-inline">
