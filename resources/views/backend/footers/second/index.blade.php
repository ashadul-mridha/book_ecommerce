            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <strong class="card-title">Foote Second Cloumn Data</strong>
                        @can('manage-footers')
                        @if (count($footers) <= 0)
                         <a class="btn btn-sm btn-success" href="{{ route('admin.second.create') }}">Add
                            Second Cloumn</a>
                            @endif
                            @endcan
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-info"
                                            href="{{ route('admin.second.edit', $footer->id) }}">
                                            Edit
                                        </a>
                                        @if (count($footers) > 1)
                                        <form action="{{ route('admin.second.destroy', $footer->id) }}" method="POST"
                                            class="d-inline">
