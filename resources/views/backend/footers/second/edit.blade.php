            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('admin.second.update', $footer->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
...
<script type="text/javascript">
    (function ($) {
    "use strict";
    $('.quick_link').not(":first").find('.col-md-9').append('<button type="button" class=" delete_item btn btn-danger btn-sm mt-2">Delete</button>');
