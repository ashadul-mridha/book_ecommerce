            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('admin.first.update', $footer->id) }}" method="POST"
                            ...
                            <div class="row form-group ">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <img class="pt-3" width="200px"
                                        src="{{asset('images/footer/' . $footer->logo)}}" alt="logo">
                                    @if ($errors->has('logo'))
                            ...
                            @php
                            $icon = explode("|", $footer->social_icon);
                            $link = explode("|", $footer->social_link);
                            $data = array_combine($icon, $link);
                            @endphp
                            ...
                            <div class="row  form-group social_clone">
                                ...
                                <div class="col-12 col-md-9">
                                    Icon Class Name: <input type="text" id="social_icon"
                                        ...
                                        name="social_icon[]"
                                        value="{{ old('social_icon', isset($key) ? $key : '') }}">
                                    ...
                                    Icon Link: <input type="text" id="social_icon"
                                        ...
                                        name="social_link[]"
                                        value="{{ old('social_link', isset($value) ? $value : '') }}">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-9 offset-md-3">
                                    <button type="button" id="social_add" class="btn btn-info btn-sm mt-2">Add
                                        New</button>
                                </div>
                            </div>
...
<script type="text/javascript">
    (function ($) {
    "use strict";
    $('.social_clone').not(":first").find('.col-md-9').append('<button type="button" class=" social_delete btn btn-danger btn-sm mt-2">Delete</button>');
