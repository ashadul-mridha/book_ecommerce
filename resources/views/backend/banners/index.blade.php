            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <strong class="card-title">All Banners Data</strong>

                        <a class="btn btn-sm btn-success" href="{{ route('admin.banners.create') }}">Add
                            Banner</a>
                    ...
                    <div class="card-body">
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $id }}</td>
                                    <td><img src="{{asset('images/banner'). '/'.$banner->image}}" alt="Logo"
                                            width="250px">
                                    </td>
                                    <td>
                                        @if ($banner->status == 1)
